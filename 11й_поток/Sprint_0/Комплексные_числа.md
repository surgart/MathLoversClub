...
<center>
<img width="350" src="./presentation/images/coordinates/linear_combination.svg">
</center>
...
<center>
<img width="350"  src="./presentation/images/complex/complex_circle.svg">
</center>
...
$\overrightarrow{OC'} = r(\cos{φ} + i\cdot\sin{φ})$

**3.** **Экспоненциальная**:

$e^{iφ}=\cos{φ} + i\cdot\sin{φ}$ - формула Эйлера

$\overrightarrow{OC'} = r\cdot e^{iφ}$
...
<tr>
<td>
<img src="./presentation/images/complex/derivative_of_exp.svg">
</td>
<td>
<img src="./presentation/images/complex/derivative_of_exp2.svg">
</td>
</table>
...
<table>
    <tr>
        <td>
            <img src="./presentation/images/complex/spiral.png"/>
            <sup>\(\text{3D}\) визуализация функции \(e^{i\varphi}\)</sup>
        </td>
        <td>
            <img src="./presentation/images/complex/Im_Re_projection.png" />
            <sup>Проекция функции \(e^{i\varphi}\) на комплексную плоскость</sup>
        </td>
    </tr>
    <tr>
        <td>
            <img src="./presentation/images/complex/Re_cos_projection.png">
            <sup>Проекция функции \(e^{i\varphi}\) на плоскость \(φ \text{Re}\)</sup>
        </td>
        <td>
            <img src="./presentation/images/complex/Im_sin_projection.png">
            <sup>Проекция функции \(e^{i\varphi}\) на плоскость \(φ \text{Im}\)</sup>
        </td>
    </tr>
</table>
...
<tr>
<td width="50%">
<img src="./presentation/images/complex/addition.svg">
</td>
<td width="50%">
$z_1 = 1 + 3i,\; z_2 = 3 - i$
...
<tr>
<td width="50%">
<img src="./presentation/images/complex/substruction.svg">
</td>
<td>
$$
z_1 = 1 + 3i \\
